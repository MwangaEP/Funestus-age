# This program uses deep learning trained with PCA transformed data to predict the 
# age structure of of Anopheles funestus mosquitoes collected from the wild
...
savedir = (outdir+"\Training_Folder_PCA")            
build_folder(savedir, True)
savedir = (outdir+"\Training_Folder_PCA\l")            
...
loaded_model = load_model("C:\Mannu\Projects\Anophles Funestus Age Grading (WILD)\Fold\Training_Folder_PCA\lCNN_0_3_Model.h5")
...
cr = cr.iloc[0:]
cr.to_csv('C:\Mannu\Projects\Anophles Funestus Age Grading (WILD)\Fold\Training_Folder_PCA\classification_report.csv')
